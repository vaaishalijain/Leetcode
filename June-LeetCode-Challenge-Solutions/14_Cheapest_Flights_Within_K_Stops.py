"""
    ...
    Q. There are n cities connected by m flights. Each flight starts from city u and arrives at v with a price w.
    ...
    def findCheapestPrice(self, n: int, flights: List[List[int]], src: int, dst: int, K: int) -> int:
        ...
        for _ in range(K + 1):
            ...
            for flight in flights:
                dp[flight[1]] = min(dp[flight[1]], odd[flight[0]] + flight[2])
